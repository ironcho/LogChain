...
def test_make_block():
    ...
    block_header_test = block.BlockHeader(
    ...
    block_header_test.block_info = block_header_test.prev_hash + \
        block_header_test.merkle_root
    ...
    block_test = block.Block(block_header_test, transactions)
    json_block_test = json.dumps(
        block_test, indent=4, default=lambda o: o.__dict__, sort_keys=True)
